...
<div class="fixed-top">
    ...
    <img id="img" src="map_move_json/dialog.png" style="display: none">
...
<script type="text/javascript">
    ...
    var character = <?=json_encode($character01)?>;
    ...
    // 圖片 中心點
    var photo_center_vertical = 10;//3 圖片初始位置 陣列 欄
    var photo_center_horizontal = 10;//6 圖片初始位置 陣列 列
        ...
        for (var v = photo_vertical_range["start"]; v <= photo_vertical_range["end"]; v++) {
            for (var h = photo_horizontal_range["start"]; h <= photo_horizontal_range["end"]; h++) {
                ...
                if (character[v][h] > 1) {
                    ...
                    console.log("character-> "+character[v][h]);
                    break;
                }
